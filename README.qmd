...
* `labren`: Tools for accessing [LABREN's global horizontal solar irradiation model](http://labren.ccst.inpe.br/atlas_2017.html).
* `model`: The entrainment model.
* `utils`: Utility tools.

You can learn more about each subpackage and its functions on the [package documentation website](https://entrainment.readthedocs.io).
...
```{python}
#| fig-alt: "Modeled 24h light/dark cycle entrainment of a population located at the south of Brazil by season"
