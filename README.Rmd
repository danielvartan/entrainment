...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "doc/source/_static/README-",
  out.width = "100%"
)
```
...
* `labren`: A subpackage to access LABREN's global horizontal solar irradiation model.
...
Please note in this example all of the model arguments are assigned. You don't need to assign values to all arguments, you can just use the default values. Check `run()` documentation to learn more.
