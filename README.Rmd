...
`entrainment` is a rule-based model created on Python to test and demonstrate the 24h light/dark cycle [entrainment phenomenon](https://en.wikipedia.org/wiki/Entrainment_(chronobiology)).
...
Please note in this example all of the model arguments are assigned. You don't need to assign all the arguments, you can just use the default values. Check the `run_model()` documentation to learn more about each argument.
